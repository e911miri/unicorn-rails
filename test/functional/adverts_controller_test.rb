...
class AdvertsControllerTest < ActionController::TestCase
  ...
  test "should create advert" do
    assert_difference('Advert.count') do
      post :create, advert: { audience: @advert.audience, duration: @advert.duration, messgae: @advert.messgae, notes: @advert.notes, url: @advert.url, user_id: @advert.user_id }
    end
  ...
  test "should update advert" do
    put :update, id: @advert, advert: { audience: @advert.audience, duration: @advert.duration, messgae: @advert.messgae, notes: @advert.notes, url: @advert.url, user_id: @advert.user_id }
    assert_redirected_to advert_path(assigns(:advert))
  end
