...
class AccomodationsControllerTest < ActionController::TestCase
  ...
  test "should create accomodation" do
    assert_difference('Accomodation.count') do
      post :create, accomodation: { location: @accomodation.location, name: @accomodation.name, notes: @accomodation.notes, size: @accomodation.size, status: @accomodation.status, type: @accomodation.type }
    end
  ...
  test "should update accomodation" do
    put :update, id: @accomodation, accomodation: { location: @accomodation.location, name: @accomodation.name, notes: @accomodation.notes, size: @accomodation.size, status: @accomodation.status, type: @accomodation.type }
    assert_redirected_to accomodation_path(assigns(:accomodation))
  end
