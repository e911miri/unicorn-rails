...
class LecturersControllerTest < ActionController::TestCase
  ...
  test "should create lecturer" do
    assert_difference('Lecturer.count') do
      post :create, lecturer: { department_id: @lecturer.department_id, userprofile_id: @lecturer.userprofile_id }
    end
  ...
  test "should update lecturer" do
    put :update, id: @lecturer, lecturer: { department_id: @lecturer.department_id, userprofile_id: @lecturer.userprofile_id }
    assert_redirected_to lecturer_path(assigns(:lecturer))
  end
